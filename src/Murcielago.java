...
public class Murcielago extends Enemigo{
	...
	public Murcielago(float x, float y, Stage s, LevelScreen nivel) {
		super(x, y, s, nivel);
		// TODO Auto-generated constructor stub
		persiguiendo=true;
		andando=loadAnimationFromSheet("assets/platform_metroidvania asset pack v1.01/enemies sprites/fly/blue_fly_idle_or_flying_anim_strip_3.png", 1, 3, 0.1f, true);
		golpeado=loadAnimationFromSheet("assets/platform_metroidvania asset pack v1.01/enemies sprites/fly/blue_fly_hit_anim_strip_3.png", 1, 3, 0.1f, true);

		velocidadMaxima=35;
		aceleracion=30000;
		vida = 1;
	}
	public Murcielago(float x, float y, Stage s, LevelScreen2 nivel) {
		super(x, y, s, nivel);
		// TODO Auto-generated constructor stub
		persiguiendo=true;
		andando=loadAnimationFromSheet("assets/platform_metroidvania asset pack v1.01/enemies sprites/fly/blue_fly_idle_or_flying_anim_strip_3.png", 1, 3, 0.1f, true);
	...
	public Murcielago(float x, float y, Stage s, LevelScreen3 nivel) {
		super(x, y, s, nivel);
		// TODO Auto-generated constructor stub
		persiguiendo=true;
		andando=loadAnimationFromSheet("assets/platform_metroidvania asset pack v1.01/enemies sprites/fly/blue_fly_idle_or_flying_anim_strip_3.png", 1, 3, 0.1f, true);
