...
public class LevelScreen2 extends BaseScreen {
	...
	TilemapActor tma;
	 public LevelScreen2(int vidas,int coins,boolean powerup1,boolean powerup2,boolean sonido) {
		 this.coins = coins;
		 this.vidas = vidas;
	...
	public void initialize() {
		...
		tma = new TilemapActor("assets/Nivel2.tmx", mainStage);
	...
	public void update(float dt) {
		...
		for (BaseActor door : BaseActor.getList(mainStage, "Puerta")) {
			if (jugador.overlaps(door) && abierto) {
				...
				BaseGame.setActiveScreen(new Tienda(vidas,coins,powerup1,powerup2,true,sonido));
		...
		jugador.setPowerup1(powerup1);
		jugador.setPowerup2(powerup2);
...
//		            timeLabel.setText("Vidas: " + jugador.getVidas());
						gameOver=true;
